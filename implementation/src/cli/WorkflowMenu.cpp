// ============================================================
// WorkflowMenu.cpp  —  F77 Freigabe-Workflow CLI
//
// workflowMenu()        : top-level browser (templates + running workflows)
// instanceMenu()        : per-workflow operations (fire step, tick, lock)
// listWfInstances()     : list F77 workflows for an entity or all active
// startWfInstanceWizard(): start a new F77 workflow
// ============================================================
...
void instanceMenu(const std::string& workflowId) {
    while (true) {
        ...
        std::cout << "  1.Schritt ausfuehren  2.Schritt validieren  3.Engine-Tick\n"
                     "  4.Workflow sperren    5.Zielzustand aendern  0.Zurueck\n";
