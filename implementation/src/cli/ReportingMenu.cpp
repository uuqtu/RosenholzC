// ============================================================
// ReportingMenu.cpp  —  Communications
//
// Milestone tracking was replaced by a free-text field on F16.
// This file now only handles the Communication entity,
// which is reachable from ProjectMenu, TaskMenu, and F18Menu.
// ============================================================
